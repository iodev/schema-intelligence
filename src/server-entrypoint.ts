...
function loadConfig(configPath: string): { crawler: SchemaCrawlerConfig; port: number; host: string } {
    ...
    const crawlerConfig: SchemaCrawlerConfig = {
...
function applyEnvOverrides(config: { crawler: SchemaCrawlerConfig; port: number; host: string }): void {
